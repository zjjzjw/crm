...
namespace Huifang\Admin\Providers;

use Huifang\Admin\Src\Auth\UserCenterUserProvider;
use Auth;
...
class UserCenterServiceProvider extends ServiceProvider
{
    ...
    {
        $user_center_service = app('Huifang\Admin\Src\UserCenter\Service\UserCenterService');
