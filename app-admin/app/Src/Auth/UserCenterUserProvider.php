<?php namespace Huifang\Admin\Src\Auth;

use Illuminate\Contracts\Auth\Authenticatable;
use Illuminate\Contracts\Auth\UserProvider;
use Huifang\Admin\Src\UserCenter\Service\UserCenterService;
...
class UserCenterUserProvider implements UserProvider
{
    ...
    public function __construct(UserCenterService $user_center_service, $model)
    {
