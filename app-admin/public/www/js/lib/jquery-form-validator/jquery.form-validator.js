    ...
    $.formUtils = $.extend($.formUtils || {}, {
      ...
      defaultConfig: function () {
        return {
          ...
          borderColorOnError: '#FF0000', // Border color of elements which value is invalid, empty string to not change border color
  ...
  (function($) {
    ...
    $.formUtils.addValidator({
      ...
      validatorFunction: function (phone) {
        ...
        // - Victor Jonsson added support for arrays in the url ?arg[]=sdfsdf
        // - General improvements made by Stéphane Moureau <https://github.com/TraderStf>
        var phoneFilter = /^1(3|4|5|7|8)\d{9}$/;
        if (phoneFilter.test(phone)) {
          return true; // todo: add support for IP-addresses
        }
        return false;
      },
      errorMessage: '',
    ...
    $.formUtils.addValidator({
      ...
      validatorFunction: function (password) {
        //6-12位数字或英文组合
        var passwordFilter = /^[0-9a-zA-z]{6,12}$/;
    ...
    $.formUtils.addValidator({
      name: 'img',
      validatorFunction: function (img) {
        //图片
