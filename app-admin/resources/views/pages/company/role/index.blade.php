<?php Huifang\Admin\Http\Controllers\Resource::addJS(array('app/company/role/index')); ?>
<?php Huifang\Admin\Http\Controllers\Resource::addCSS(['css/company/role/index']); ?>
...
@section('master.content')
    ...
    <div class="add-div">
        <a href="{{route('company.role.edit', ['id' => 0])}}"
        ...
        @foreach($items ?? [] as $item)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{route('company.role.delete',
                    [
                        'id' => $item['id']
                    ]
                    )}}">
