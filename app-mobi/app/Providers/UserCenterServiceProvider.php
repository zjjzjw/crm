...
namespace Huifang\Mobi\Providers;

use Huifang\Mobi\Src\Auth\UserCenterUserProvider;
use Auth;
...
class UserCenterServiceProvider extends ServiceProvider
{
    ...
    {
        $user_center_service = app('Huifang\Mobi\Src\UserCenter\Service\UserCenterService');
