...
class ProjectStoreForm extends Form
{
    ...
    public function validation()
    {
        if (array_get($this->data, 'id')) {
            ...
            //得到创建者
            $project_entity->created_user_id = $user_entity->id;
            $project_entity->user_id = $user_entity->id;
            $project_entity->company_id = $user_entity->company_id;
        }
        ...
        if (!empty(array_get($this->data, 'project_corp_user_ids'))) {
            $project_entity->project_corp_user_ids = json_decode(array_get($this->data, 'project_corp_user_ids'), true);
        }
