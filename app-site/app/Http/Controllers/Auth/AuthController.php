...
namespace Huifang\Site\Http\Controllers\Auth;

use Huifang\Site\Http\Controllers\BaseController;
...
class AuthController extends BaseController
{
    ...
    {
        $error_msg = app('Huifang\Site\Src\UserCenter\Service\UserCenterService')->getFailedLoginMessage();
