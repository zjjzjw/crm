<?php Huifang\Web\Http\Controllers\Resource::addJS(array('app/customer/structure/detail')); ?>
...
@section('content')
    ...
    <div class="detail-content">
        ...
        [
        'title' => "组织架构详情",
        'url' => route('customer.structure.edit', ['customer_id' => $customer_id,'parent_id' => $parent_id, 'id'=> $id]),
        'type' => 1,//删除和编辑
        'id'  => $id  ?? 0,
        'user_id' => $user_id ?? 0,
        'user'    => $user ?? [],
        'edit_permission' => 'customer.structure.edit'
        ])
