<?php Huifang\Web\Http\Controllers\Resource::addJS(array('app/customer/structure/edit')); ?>
    ...
    <div class="edit-content">
        ...
        <form id="form_creat" action="" class="creat-box" method="POST">
            <p class="first-top"><span>姓名</span>
                <input class="auto-ipt"  @if(empty($id))id="auto_ipt"@endif name="name" placeholder="点击输入" value="{{$name or ''}}" maxlength="10"
                       data-required="true"
            ...
            <p>
                <span>兴趣点</span>
                <input name="interest" placeholder="点击输入" value="{{$interest or ''}}"
                       data-required="true"
            ...
            <p>
                <span>突破计划</span>
                <input name="breakthrough_plan" placeholder="点击输入" value="{{$breakthrough_plan or ''}}"
                       data-required="true"
            ...
            <p>
                <span>举证</span>
                <input name="proof" placeholder="点击输入" value="{{$proof or ''}}"
                       data-required="true"
            ...
            <p>
                <span>痛苦描述</span>
                <input name="pain_desc" placeholder="点击输入" value="{{$pain_desc or ''}}"
                       data-required="true"
            ...
            <div class="save-box">
                ...
                <input name="project_id" type="hidden" value="{{$customer_id or 0}}">
