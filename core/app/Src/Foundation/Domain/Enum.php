...
use Huifang\Src\Foundation\Domain\Exceptions\EnumNotExists;
use Huifang\Src\Foundation\Support\Interfaces\Printable;
use Huifang\Src\Foundation\Support\Interfaces\Validatable;
use Huifang\Src\Foundation\Support\Traits\Validating;
...
abstract class Enum extends ValueObject implements Printable, Validatable
{
     ...
     *
     * @throws \Huifang\Src\Foundation\Domain\Exceptions\EnumNotExists
     */
