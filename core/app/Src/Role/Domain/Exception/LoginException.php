<?php namespace Huifang\Src\Role\Domain\Exception;
...
class LoginException extends BaseException
{
    ...
    const ERROR_USER_NOT_EXPIRE = 1024;
    const ERROR_ACCOUNT_PROVIDER = 1025;
    const ERROR_MODEL_NO_EXIST = 1026;
    const ERROR_ACCOUNT_DISABLE = 1027;
    const ERROR_NO_LOGIN = 1028;
    const ERROR_NO_FORMAL_ACCOUNT = 1029;
    const ERROR_PASSWORD = 1030;
