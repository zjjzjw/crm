...
use Huifang\Src\Role\Domain\Interfaces\UserFeedbackInterface;
use Huifang\Src\Role\Domain\Model\UserFeedbackEntity;
use Huifang\Src\Role\Domain\Model\UserFeedbackSpecification;
use Huifang\Src\Role\Infra\Eloquent\UserFeedbackModel;
...
class UserFeedbackRepository extends Repository implements UserFeedbackInterface
{
     ...
     *
     * @return \Huifang\Src\Role\Domain\Model\UserFeedBackEntity
     */
