...
use Huifang\Src\Surport\Domain\Interfaces\ResourceInterface;
use Huifang\Src\Surport\Domain\Model\ResourceEntity;
use Huifang\Src\Surport\Infra\Eloquent\ResourceModel;
...
class ResourceRepository extends Repository implements ResourceInterface
{
    ...
    private $bucket_info = [
        'img-pro' => [
            'domain'  => 'img.chengnuozx.com',
            'private' => false,
        ],
        'img-dev' => [
            'domain'  => 'img-dev.chengnuozx.com',
            'private' => false,
        ],
    ];
